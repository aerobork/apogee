...
class Transition extends AxialComponent {
    ...
    _calcCG() {
        ...
        this.cg = (this._calcVolume() * this.state.density * comOuter - massInner * comInner) / (this._calcVolume() * this.state.density - massInner);

        return this.cg;
    }   
}

let bt = new Transition(2.5, 2.3, 20, 0.68, 1.2, 0, 10, 10, 0, 0);
bt.setState({});
console.log(bt.mass);
console.log(bt.cg);
